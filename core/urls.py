...
from .views import AboutUsView, ContactView, DescriptionView, HomeView, MarketRateView, PortafolioView, ProsoftListView, ProsoftDocView, ServicesView, SalesGobView

urlpatterns = [
    path('', HomeView.as_view(), name='home'),
    path('ventas/', SalesGobView.as_view(), name='ventas'),
